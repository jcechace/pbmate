...
//
// Every Command has a Validate method that checks field constraints before
// dispatch. [CommandService.Send] calls Validate automatically; callers
// may also call it directly for early feedback.
type Command interface {
	kind() string    // unexported method prevents external implementations
	Validate() error // checks field constraints; returns nil when valid
}
